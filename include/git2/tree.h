 ...
 */
typedef enum {
	/** Update or inert an entry at the specified path */
 ...
 */
GIT_EXTERN(int) git_tree_create_updated(git_oid *out, git_tree *baseline, size_t nupdates, git_tree_update **updates);
